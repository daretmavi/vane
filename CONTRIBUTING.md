...
There are a lot of things that you can do to help the project. And contributions don't necessarily have to involve
coding. Below, I've written a short checklist of things that you can check:
...
You can open a draft PR while you are working on your changes to allow us to provide early feedback on your
implementation.
...
- Vane is opinionated. If you want to make a contribution, please communicate with us before you start implementing, so
  we can help you design the feature in vane's spirit. We also want to avoid it that two people unknowingly work on the
  same thing.
